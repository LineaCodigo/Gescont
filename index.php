...
//-------------- Vista de paginas ------------------//
 ...
 $app->get('/servicios',  function(){  
    include_once 'View/servicios.php';  
 });

 $app->get('/capacitaciones',  function(){  
    include_once 'View/capacitaciones.php';  
 });

 $app->get('/conocenos',  function(){  
    include_once 'View/conocenos.php';  
 });
